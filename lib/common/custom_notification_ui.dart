...
class CustomNotificationUi extends StatefulWidget {
  CustomNotificationUi(this.notiModel);
...
class _CustomNotificationUiState extends State<CustomNotificationUi> {
